	...
	return (
		<Row align="middle" justify="space-around" gutter={[0, 30]}>
			<Col xs={24} sm={24} md={24} lg={8} xl={8}>
				...
				<div>© 2023 [COMPANY]. All rights reserved.</div>
				<GapComponent height={20} />
				<Space>
					<Button icon={<i className="bx bxl-linkedin" />} shape="circle" type="primary" size="large" target="_blank" />
					<Button icon={<i className="bx bxs-envelope" />} shape="circle" type="primary" size="large" target="_blank" />
					<Button
			...
			<Col xs={24} sm={24} md={24} lg={8} xl={8}>
				<h1>Contact Us</h1>
				<div>
					<i className="bx-fw bx bxs-buildings" /> [COMPANY]
				</div>
				<GapComponent height={10} />
				<div>
					<i className="bx-fw bx bxs-envelope" /> company@email.com
				</div>
			</Col>
		</Row>
	)
